...
document.write('<iframe src="//www.licznikodwiedzin.pl/cnt/cnt.php?key=184578519&amp;minDigits=7" width="187px" height="51px" id="counterForWebsiteFrame" marginheight="0" frameborder="0" style="margin: 0; border:0; padding: 0;" scrolling="no"></iframe>');
document.write('</div>');
